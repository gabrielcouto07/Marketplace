...
```json
{ "postalCode": "01310100", "sellerId": "guid", "items": [{ "productId": "guid", "variantId": null, "quantity": 1 }] }
```
...
```json
{ "id": "guid", "from": "BRL", "to": "PYG", "numerator": 1389, "denominator": 100,
  "displayRate": "R$ 1,00 = ₲ 1.389", "quotedAt": "…", "expiresAt": "…" }
```
...
```json
{ "postalCode": "01310100", "couponCode": "PARAGUAI10",
  "groups": [{ "sellerId": "guid", "shippingOptionId": "guid|null",
...
```json
{ "id": "evt_…", "type": "payment.approved", "occurredAt": "…", "payload": { "paymentId": "…", "purchaseId": "…" } }
```
