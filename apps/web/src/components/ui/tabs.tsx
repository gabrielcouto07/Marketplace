...
const tabsListVariants = cva(
  "group/tabs-list flex w-full items-center justify-center text-muted-foreground group-data-vertical/tabs:flex-col",
  {
    variants: {
      variant: {
        default: "gap-1 rounded-lg bg-surface-strong p-1",
