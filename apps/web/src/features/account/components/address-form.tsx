  ...
  return (
    <form onSubmit={submit} noValidate className="flex flex-col gap-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        <FormField id="addr-cep" label={t("postalCode")} error={cepError}>
          <div className="relative">
            ...
            {lookup.isFetching ? (
              <Loader2
                className="absolute top-1/2 right-3.5 size-4 -translate-y-1/2 animate-spin text-primary"
      ...
      <Controller
        ...
        name="isDefault"
        render={({ field }) => (
          <Label className="min-h-12 cursor-pointer rounded-lg border-[1.5px] border-transparent bg-surface px-3.5 py-3 text-[13.5px] transition-colors has-checked:border-primary has-checked:bg-selected">
            <Checkbox
              id="addr-default"
      ...
      <Button type="submit" variant="cta" size="lg" disabled={submitting} className="mt-1">
