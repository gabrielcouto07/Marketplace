...
| [docs/DESIGN_SYSTEM.md](docs/DESIGN_SYSTEM.md)             | identidade (Claude Design), tokens de cor, tintas por categoria, raios, animações, componentes, cabeçalhos por página                  |
